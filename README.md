...
Full-stack Software Engineer with 5+ years of experience architecting HIPAA-compliant
healthcare platforms, enterprise CRM systems, and supply chain planning tools using
Node.js, Angular, and TypeScript. I deliver event-driven architectures, real-time
communication systems (WebRTC, Socket.IO), and distributed data pipelines (Kafka, Debezium)
at scale — translating complex domain requirements into reliable, production-grade software
within Agile/Scrum teams.

Currently: **Senior Application Developer @ TransImpact** — building a Supply Chain Demand
Planning product with NestJS, Angular 19, and Microsoft SQL Server.
